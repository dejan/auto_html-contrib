...
RSpec.describe AutoHtml::Vimeo do
  it 'transform vimeo url' do
    ...
    expect(result).to eq '<iframe src="//player.vimeo.com/video/3300155" width="420" height="315" frameborder="0" webkitallowfullscreen="yes" mozallowfullscreen="yes" allowfullscreen="yes"></iframe>'
  end
  ...
  it 'transform vimeo url wth options' do
    ...
    expect(result).to eq '<iframe src="//player.vimeo.com/video/3300155" width="300" height="250" frameborder="0" webkitallowfullscreen="yes" mozallowfullscreen="yes" allowfullscreen="yes"></iframe>'
  end
end
